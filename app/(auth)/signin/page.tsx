...
export const generateMetadata = async (): Promise<Metadata> => {
  ...
  return {
    title: `${result?.title || 'Shop App'} | Sign In`,
    description: `${result?.slogan || 'Shop App'} Sign In`,
    keywords: `${result?.title || 'Shop app'}, Sign In`,
    authors: [
      {
        name: 'Alfredo',
    ...
    openGraph: {
      title: `${result?.title || 'Shop App'} | Sign In`,
      description: `${result?.title || 'Shop App'} Sign In`,
